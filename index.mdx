...
<div className="py-12 px-4">
  <div className="text-xs font-semibold tracking-widest uppercase mb-3" style={{color: 'var(--primary)'}}>
    Getting started
  </div>
  ...
  <p className="text-lg max-w-2xl" style={{color: 'var(--muted-foreground)'}}>
    Run AI-powered analysis on your sales conversations. Surface structured insights, evidence, and scorecards — via the app, API, or MCP.
  </p>
</div>
